...
const TodoItem = ({todo, onRemovePressed}) => {
    ...
    const [updatedText, setUpdateText] = useState(todo?.text);
    ...
    return (
        <div className="todo-item">
            ...
            value={updatedText}
            onChange={e => setUpdateText(e.target.value)} /> : <p>{todo.text}</p>
        }
        <div className="button-container">{/* <button className=”mark-completed-button”> Mark as Completed </button> */}
